...
import { removeToken, removeUser } from '../../utils/auth'; // Added missing imports

const AppNavbar = () => {
  const { user, isAuth, loading } = useAuth();
  
  useEffect(() => {
    console.log('Navbar auth state:', { isAuth, user, loading });
  }, [isAuth, user, loading]);
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            {authenticated && currentUser?.role === 'worker' && (
              <>
                <LinkContainer to="/worker/requests">
                  <Nav.Link>Available Jobs</Nav.Link>
                </LinkContainer>
